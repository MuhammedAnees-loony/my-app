  ...
  return (
    <div className="App">
      <nav className="navbar">
        <div className="logo">Muhammed Anees</div>
      ...
      <header className="hero-section">
        <img src={profileImage} alt="Muhammed Anees" className="profile-img" />
        <div className="hero-text">
          <p>Hello, I'm</p>
          <h1>Muhammed Anees</h1>
          ...
          <div className="social-icons">
            <a href="https://www.linkedin.com/in/muhammed-anees-18b225318/" target="_blank" rel="noopener noreferrer">
              <FaLinkedin size={30} />
            </a>
            <a href="https://github.com/MuhammedAnees-loony" target="_blank" rel="noopener noreferrer">
              <FaGithub size={30} />
            </a>
            <a href="https://www.hackerrank.com/profile/muhammedanees921" target="_blank" rel="noopener noreferrer">
              <FaHackerrank size={30} color="#2EC866" />
            </a>
            <a href="https://leetcode.com/u/Muhammed_Anees09/" target="_blank" rel="noopener noreferrer">
      ...
      <div className="center-button">
        <a
          href="mailto:muhammedanees922059@gmail.com?subject=Hiring%20Opportunity&body=Hi%20Anees%2C%0AI'm%20interested%20in%20your%20profile."
    ...
    <section id="contact" className="contact-section">
        <h2>Contact Me</h2>
        <p>Email: muhammedanees922059@gmail.com</p>
        <p>Phone: +91-6238041331</p>
